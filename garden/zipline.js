...
import {ZIPLINE,ZIP_JOIN,zipSample} from './zipline-state.mjs';
import {createZiplineCable} from './zipline-cable.js';
import {LOOKOUT} from './lookout-layout.mjs';
import {terrainHeight} from './walk-route.mjs';
export function createZipline(scene,wood,metal,renderer){
 ...
 const cable=createZiplineCable(root,renderer);
 ...
 update();return {root,obstacles,update,updateDetail:cable.updateDetail};
}
